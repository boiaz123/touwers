...
export class Level4 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        const waveConfigs = [
            ...
            { enemyCount: 10, enemyHealth: 25, enemySpeed: 35, spawnInterval: 1.5, pattern: ['shieldknight'] },
            // Wave 2: Add villagers, still easy
            { enemyCount: 14, enemyHealth: 28, enemySpeed: 36, spawnInterval: 1.5, pattern: ['knight'] },
            // Wave 3: More enemies, more variety
            { enemyCount: 17, enemyHealth: 32, enemySpeed: 38, spawnInterval: 1.5, pattern: ['mage'] },
