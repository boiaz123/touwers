            ...
            if (x >= iconX - (iconSize/2 + clickBuffer) && x <= iconX + (iconSize/2 + clickBuffer) &&
                ...
                if (tower.constructor.name === 'MagicTower') {
                    ...
                    return {
                        ...
                        tower: tower,
                        elements: [
                            { id: 'fire', name: 'Fire', emblemIcon: '🔥', description: 'Burn damage over time' },
                            { id: 'water', name: 'Water', emblemIcon: '💧', description: 'Slows and freezes enemies' },
                            { id: 'air', name: 'Air', emblemIcon: '💨', description: 'Chains to nearby enemies' },
                            { id: 'earth', name: 'Earth', emblemIcon: '⛰️', description: 'Pierces armor' }
                        ],
