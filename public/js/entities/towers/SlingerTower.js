...
export class SlingerTower extends BasicTower {
    ...
    // canvas-drawn rune stone below and as the sprite tint TowerRenderAdapter applies
    ...
    renderDynamicParts(ctx, gridSize) {
        ...
        this.renderTransformBadge(ctx, gridSize, { color: SlingerTower.TRANSFORM_COLOR, symbol: 'burst', groundYFactor: 0.24 });
    }
