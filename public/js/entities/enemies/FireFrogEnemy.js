...
export class FireFrogEnemy extends BaseEnemy {
    ...
    render(ctx) {
        ...
        bodyGradient.addColorStop(0, FireFrogEnemy.getCachedColor(this.skinColor, 'lighten'));
        ...
        // Belly (lighter color)
        ctx.fillStyle = FireFrogEnemy.getCachedColor(this.skinColor, 'lighten_body');
        ctx.beginPath();
        ...
        // Left eye socket
        ctx.fillStyle = FireFrogEnemy.getCachedColor(this.skinColor, 'darken_eye');
        ctx.beginPath();
        ...
        // Wide frog mouth
        ctx.strokeStyle = FireFrogEnemy.getCachedColor(this.skinColor, 'darken_mouth');
        ctx.lineWidth = 1.2;
        ctx.beginPath();
        ...
        // Nostril details
        ctx.fillStyle = FireFrogEnemy.getCachedColor(this.skinColor, 'darken_detail');
        ctx.beginPath();
    ...
    drawFrogBackLeg(ctx, hipX, hipY, baseSize, isRight) {
        ...
        ctx.fillStyle = FireFrogEnemy.getCachedColor(this.skinColor, 'lighten_foot');
        ctx.beginPath();
        ctx.ellipse(footX, footY, baseSize * 0.16, baseSize * 0.18, calfAngle, 0, Math.PI * 2);
        ctx.fill();
        
        // Toe details - webbing
        ctx.strokeStyle = FireFrogEnemy.getCachedColor(this.skinColor, 'darken_detail');
        ctx.lineWidth = 0.8;
        for (let i = -1; i <= 1; i++) {
    ...
    drawWizardHat(ctx, baseSize) {
        // Hat body - large pointy cone - Fire colored
        const hatGradient = ctx.createLinearGradient(-baseSize * 0.35, -baseSize * 0.8, baseSize * 0.35, -baseSize * 1.5);
        hatGradient.addColorStop(0, '#E74C3C');
        hatGradient.addColorStop(0.6, '#C0392B');
        hatGradient.addColorStop(1, '#7B241C');
