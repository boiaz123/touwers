...
export class MountainLevel7 extends LevelBase {
    ...
    constructor() {
        ...
        this.terrainElements = [
            ...
            { type: 'vegetation', gridX: 36.00, gridY: 1.00, size: 1.5, variant: 0 },
            { type: 'vegetation', gridX: 36.00, gridY: 4.00, size: 1.5, variant: 0 },
            { type: 'vegetation', gridX: 33.00, gridY: 3.00, size: 1.5, variant: 0 },
            ...
            { type: 'vegetation', gridX: 36.00, gridY: 2.00, size: 1.5, variant: 3 },
            { type: 'vegetation', gridX: 39.00, gridY: 1.00, size: 1.5, variant: 3 },
            { type: 'vegetation', gridX: 39.00, gridY: 3.00, size: 1.5, variant: 3 },
            { type: 'vegetation', gridX: 34.00, gridY: 4.00, size: 1.5, variant: 3 },
            ...
            { type: 'rock', gridX: 49.00, gridY: 11.00, size: 1.5, variant: 0 },
            { type: 'rock', gridX: 54.00, gridY: 14.00, size: 1.5, variant: 0 },
            { type: 'rock', gridX: 55.00, gridY: 13.00, size: 1.5, variant: 2 },
            { type: 'rock', gridX: 50.00, gridY: 17.00, size: 1.5, variant: 2 },
            { type: 'rock', gridX: 52.00, gridY: 11.00, size: 2, variant: 3 },
            { type: 'vegetation', gridX: 52.00, gridY: 10.00, size: 2, variant: 0 },
            { type: 'vegetation', gridX: 54.00, gridY: 5.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 56.00, gridY: 24.00, size: 3, variant: 1 },
            { type: 'vegetation', gridX: 41.00, gridY: 32.00, size: 3, variant: 1 },
            { type: 'vegetation', gridX: 51.00, gridY: 32.00, size: 3, variant: 2 },
            { type: 'vegetation', gridX: 57.00, gridY: 29.00, size: 3, variant: 2 },
            { type: 'vegetation', gridX: 54.00, gridY: 27.00, size: 3, variant: 2 },
            { type: 'vegetation', gridX: 48.00, gridY: 32.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 56.00, gridY: 32.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 59.00, gridY: 25.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 44.00, gridY: 32.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 46.00, gridY: 31.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 53.00, gridY: 30.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 59.00, gridY: 32.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 59.00, gridY: 21.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 53.00, gridY: 24.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 52.00, gridY: 28.00, size: 3, variant: 0 }
        ];
    }
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 1.1, 
            spawnInterval: 1.5, 
            pattern: [{ type: 'beefyenemy', count: 20 }] 
        }
        // Wave 5
        , { 
            ...
            spawnInterval: 1, 
            pattern: [{ type: 'villager', count: 55 }] 
        }
        // Wave 6
        , { 
            ...
            spawnInterval: 0.4, 
            pattern: [{ type: 'beefyenemy', count: 3 }] 
        }
        // Wave 7
        , { 
        ...
        , { 
            ...
            spawnInterval: 0.8, 
            pattern: [{ type: 'beefyenemy', count: 12 }, { type: 'shieldknight', count: 3 }, { type: 'knight', count: 1 }] 
        }
        // Wave 10
        , { 
        ...
        , { 
            ...
            spawnInterval: 0.8, 
            pattern: [{ type: 'archer', count: 9 }, { type: 'basic', count: 6 }, { type: 'villager', count: 15 }, { type: 'beefyenemy', count: 3 }, { type: 'shieldknight', count: 5 }, { type: 'knight', count: 3 }] 
        }
        // Wave 12
        , { 
            enemyHealth_multiplier: 4, 
        ...
        , { 
            ...
            speedMultiplier: 1.30, 
            spawnInterval: 0.5, 
            pattern: [{ type: 'basic', count: 19 }, { type: 'villager', count: 18 }, { type: 'archer', count: 18 }] 
        }
        // Wave 14
        , { 
            enemyHealth_multiplier: 4, 
            ...
            spawnInterval: 0.4, 
            pattern: [{ type: 'shieldknight', count: 5 }, { type: 'ramcart', count: 1 }] 
        }
        // Wave 15
        , { 
