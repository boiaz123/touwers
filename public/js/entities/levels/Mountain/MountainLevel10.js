...
export class MountainLevel10 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 0.6, 
            spawnInterval: 0.4, 
            pattern: [{ type: 'beefyenemy', count: 4 }, { type: 'ramcart', count: 2 }, { type: 'shieldknight', count: 1 }] 
        }
        // Wave 13
        , { 
        ...
        , { 
            ...
            spawnInterval: 0.7, 
            pattern: [{ type: 'ramcart', count: 1 }, { type: 'mage', count: 1 }, { type: 'shieldknight', count: 1 }] 
        }
        // Wave 21
        , { 
