...
export class MountainLevel12 extends LevelBase {
    static levelMetadata = { name: 'Avalanche Pass', difficulty: 'Hard', order: 12, campaign: 'mountain' };
    constructor() {
        super();
        this.levelName = MountainLevel12.levelMetadata.name;
        this.levelNumber = MountainLevel12.levelMetadata.order;
        this.difficulty = MountainLevel12.levelMetadata.difficulty;
        this.campaign = MountainLevel12.levelMetadata.campaign;
        this.maxWaves = 1;
