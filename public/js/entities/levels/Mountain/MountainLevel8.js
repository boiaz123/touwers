...
export class MountainLevel8 extends LevelBase {
    ...
    constructor() {
        ...
        this.terrainElements = [
            { type: 'vegetation', gridX: 59.00, gridY: 29.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 56.00, gridY: 27.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 53.00, gridY: 33.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 47.00, gridY: 33.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 50.00, gridY: 32.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 54.00, gridY: 27.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 59.00, gridY: 22.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 59.00, gridY: 17.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 56.00, gridY: 16.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 54.00, gridY: 11.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 50.00, gridY: 7.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 58.00, gridY: 6.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 59.00, gridY: 1.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 54.00, gridY: 2.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 52.00, gridY: 5.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 47.00, gridY: 2.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 42.00, gridY: 4.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 39.00, gridY: 0.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 40.00, gridY: 2.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 44.00, gridY: 1.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 50.00, gridY: 10.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 56.00, gridY: 24.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 48.00, gridY: 32.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 44.00, gridY: 33.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 57.00, gridY: 33.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 58.00, gridY: 27.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 52.00, gridY: 26.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 54.00, gridY: 23.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 57.00, gridY: 21.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 58.00, gridY: 14.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 53.00, gridY: 13.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 58.00, gridY: 10.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 54.00, gridY: 8.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 58.00, gridY: 3.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 49.00, gridY: 2.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 48.00, gridY: 5.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 44.00, gridY: 7.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 38.00, gridY: 3.00, size: 3, variant: 3 },
            { type: 'vegetation', gridX: 33.00, gridY: 1.00, size: 3, variant: 3 },
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            spawnInterval: 0.7, 
            pattern: [{ type: 'shieldknight', count: 4 }, { type: 'ramcart', count: 1 }] 
        }
        // Wave 8
        , { 
            enemyHealth_multiplier: 3.5, 
