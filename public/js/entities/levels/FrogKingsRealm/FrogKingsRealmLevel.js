...
export class FrogKingsRealmLevel extends LevelBase {
    ...
    constructor() {
        ...
        this.terrainElements = [
            ...
            { type: 'vegetation', gridX: 31, gridY: 8,  size: 2.0, variant: 3  },
            // Near-lab gap row (y 12-17, right of lab at x>=38)
            { type: 'vegetation', gridX: 38, gridY: 12, size: 2.3, variant: 9  },
            ...
            { type: 'vegetation', gridX: 46, gridY: 15, size: 2.1, variant: 13 },
            { type: 'rock',       gridX: 48, gridY: 12, size: 1.6 },
            { type: 'vegetation', gridX: 50, gridY: 14, size: 2.4, variant: 19 },
            ...
            { type: 'vegetation', gridX: 58, gridY: 12, size: 2.0, variant: 4  },
            { type: 'drybush',    gridX: 60, gridY: 14, size: 1.3 },
            { type: 'cactus',     gridX: 62, gridY: 11, size: 1.6, variant: 1 },
            { type: 'vegetation', gridX: 64, gridY: 13, size: 2.2, variant: 14 },
            { type: 'rock',       gridX: 66, gridY: 15, size: 1.4 },
            { type: 'vegetation', gridX: 68, gridY: 12, size: 2.5, variant: 20 },
            // Very top strip (y 16-17)
            { type: 'rock',       gridX: 2,  gridY: 16, size: 1.5 },
            { type: 'vegetation', gridX: 5,  gridY: 17, size: 1.9, variant: 5  },
            ...
            { type: 'vegetation', gridX: 17, gridY: 17, size: 2.0, variant: 15 },
            ...
            { type: 'vegetation', gridX: 29, gridY: 17, size: 2.1, variant: 21 },
            { type: 'drybush',    gridX: 38, gridY: 17, size: 1.2 },
            { type: 'rock',       gridX: 41, gridY: 16, size: 1.5 },
            { type: 'vegetation', gridX: 44, gridY: 17, size: 2.0, variant: 0  },
            ...
            { type: 'vegetation', gridX: 20, gridY: 23, size: 2.4, variant: 7  },
            ...
            { type: 'vegetation', gridX: 29, gridY: 23, size: 2.1, variant: 11 },
            ...
            { type: 'vegetation', gridX: 40, gridY: 23, size: 2.3, variant: 17 },
            ...
            { type: 'vegetation', gridX: 51, gridY: 23, size: 2.0, variant: 2  },
            ...
            { type: 'vegetation', gridX: 63, gridY: 23, size: 2.2, variant: 8  },
            { type: 'rock',       gridX: 66, gridY: 24, size: 1.6 },
            { type: 'drybush',    gridX: 68, gridY: 23, size: 1.2 },
            // Mid-lower (y 26-32)
            { type: 'vegetation', gridX: 2,  gridY: 28, size: 2.4, variant: 12 },
            { type: 'rock',       gridX: 5,  gridY: 30, size: 1.7 },
            { type: 'cactus',     gridX: 7,  gridY: 27, size: 1.5, variant: 2 },
            { type: 'vegetation', gridX: 10, gridY: 29, size: 2.1, variant: 18 },
            ...
            { type: 'vegetation', gridX: 28, gridY: 27, size: 2.0, variant: 9  },
            { type: 'cactus',     gridX: 31, gridY: 30, size: 1.6, variant: 0 },
            { type: 'rock',       gridX: 34, gridY: 28, size: 1.5 },
            { type: 'vegetation', gridX: 37, gridY: 31, size: 2.3, variant: 13 },
            ...
            { type: 'vegetation', gridX: 49, gridY: 28, size: 2.2, variant: 19 },
            { type: 'drybush',    gridX: 51, gridY: 31, size: 1.3 },
            { type: 'rock',       gridX: 54, gridY: 27, size: 1.6 },
            { type: 'vegetation', gridX: 57, gridY: 29, size: 2.0, variant: 4  },
            ...
            { type: 'vegetation', gridX: 67, gridY: 28, size: 2.4, variant: 14 },
            // Bottom strip (y 34-38)
            { type: 'vegetation', gridX: 1,  gridY: 35, size: 2.3, variant: 20 },
            { type: 'rock',       gridX: 4,  gridY: 37, size: 1.5 },
            { type: 'cactus',     gridX: 7,  gridY: 35, size: 1.6, variant: 2 },
            { type: 'vegetation', gridX: 10, gridY: 36, size: 2.0, variant: 5  },
            { type: 'drybush',    gridX: 13, gridY: 38, size: 1.3 },
            { type: 'rock',       gridX: 16, gridY: 35, size: 1.4 },
            { type: 'vegetation', gridX: 19, gridY: 37, size: 2.5, variant: 15 },
            ...
            { type: 'vegetation', gridX: 30, gridY: 35, size: 2.1, variant: 21 },
            { type: 'cactus',     gridX: 33, gridY: 37, size: 1.6, variant: 4 },
            { type: 'rock',       gridX: 36, gridY: 35, size: 1.8 },
            { type: 'vegetation', gridX: 39, gridY: 38, size: 2.0, variant: 0  },
            ...
            { type: 'vegetation', gridX: 51, gridY: 35, size: 2.4, variant: 6  },
            ...
            { type: 'vegetation', gridX: 63, gridY: 37, size: 2.2, variant: 10 },
            { type: 'drybush',    gridX: 65, gridY: 35, size: 1.3 },
            { type: 'rock',       gridX: 67, gridY: 38, size: 1.5 },
            { type: 'vegetation', gridX: 69, gridY: 36, size: 1.9, variant: 16 }
        ];
    }
