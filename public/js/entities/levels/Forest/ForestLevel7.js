...
export class ForestLevel7 extends LevelBase {
    ...
    constructor() {
        ...
        this.terrainElements = [
            ...
            { type: 'vegetation', gridX: 3.00, gridY: 27.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 27.00, gridY: 32.00, size: 3, variant: 0 },
            { type: 'vegetation', gridX: 4.00, gridY: 11.00, size: 3, variant: 0 },
            ...
            { type: 'rock', gridX: 22.00, gridY: 5.00, size: 3, variant: 3 },
