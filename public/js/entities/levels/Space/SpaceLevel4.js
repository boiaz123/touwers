...
export class SpaceLevel4 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        // Wave 2
        , { 
            enemyHealth_multiplier: 1.48, 
            speedMultiplier: 1, 
            spawnInterval: 1.14, 
            pattern: [{ type: 'basic', count: 9 }, { type: 'basic', count: 11, healthMultiplier: 1.5 }, { type: 'villager', count: 7, healthMultiplier: 1.3 }] 
        }
        // Wave 3
        , { 
            enemyHealth_multiplier: 1.75, 
            speedMultiplier: 1, 
            spawnInterval: 0.68, 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.96, 
            pattern: [{ type: 'basic', count: 9, healthMultiplier: 1.8, speedMultiplier: 0.6 }, { type: 'villager', count: 11, healthMultiplier: 1.8 }, { type: 'archer', count: 4, speedMultiplier: 1.5 }] 
        }
        // Wave 6
        , { 
            ...
            speedMultiplier: 1.2, 
            spawnInterval: 0.58, 
            pattern: [{ type: 'basic', count: 12 }, { type: 'villager', count: 10 }, { type: 'frog', count: 9, healthMultiplier: 2, speedMultiplier: 1.3 }] 
        }
        // Wave 7
        , { 
            enemyHealth_multiplier: 2.85, 
            speedMultiplier: 1.2, 
            spawnInterval: 0.78, 
            pattern: [{ type: 'villager', count: 11 }, { type: 'basic', count: 9 }, { type: 'archer', count: 11, speedMultiplier: 1.2 }] 
        }
        // Wave 8
        , { 
        ...
        // Wave 11
        , { 
            enemyHealth_multiplier: 3.81, 
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'knight', count: 4, healthMultiplier: 2.5 }, { type: 'mage', count: 7 }, { type: 'frog', count: 12, speedMultiplier: 1.3 }, { type: 'archer', count: 11, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 8 }, { type: 'basic', count: 8 }] 
        }
        // Wave 12
        , { 
            enemyHealth_multiplier: 3.94, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 9, healthMultiplier: 3 }, { type: 'frog', count: 14 }, { type: 'shieldknight', count: 3, healthMultiplier: 2 }, { type: 'villager', count: 11 }, { type: 'basic', count: 10 }, { type: 'mage', count: 6 }, { type: 'archer', count: 9, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 13
        , { 
            enemyHealth_multiplier: 4.07, 
            speedMultiplier: 1, 
            spawnInterval: 0.82, 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 1, 
            pattern: [{ type: 'knight', count: 3, healthMultiplier: 3 }, { type: 'mage', count: 4, healthMultiplier: 8 }, { type: 'shieldknight', count: 3, healthMultiplier: 2 }, { type: 'mage', count: 3, healthMultiplier: 6 }, { type: 'frog', count: 4 }] 
        }
        // Wave 19
        , { 
            enemyHealth_multiplier: 4.84, 
            speedMultiplier: 1, 
            spawnInterval: 1, 
        ...
        // Wave 22
        , { 
            enemyHealth_multiplier: 5.23, 
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'mage', count: 6, healthMultiplier: 8 }, { type: 'shieldknight', count: 4 }, { type: 'basic', count: 15 }, { type: 'mage', count: 5, healthMultiplier: 4 }, { type: 'beefyenemy', count: 13, healthMultiplier: 2 }, { type: 'shieldknight', count: 4 }, { type: 'frog', count: 22 }, { type: 'archer', count: 14, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'mage', count: 4, healthMultiplier: 6 }] 
        }
        // Wave 23
        , { 
        ...
        // Wave 25
        , { 
            enemyHealth_multiplier: 5.62, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 10, healthMultiplier: 3 }, { type: 'frog', count: 22 }, { type: 'shieldknight', count: 4, healthMultiplier: 2 }, { type: 'villager', count: 12 }, { type: 'basic', count: 11 }, { type: 'mage', count: 7 }, { type: 'archer', count: 10, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 26
        , { 
        ...
        , { 
            ...
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'walkingfrog', count: 5, healthMultiplier: 2.5 }, { type: 'mage', count: 8 }, { type: 'frog', count: 20, speedMultiplier: 1.3 }, { type: 'archer', count: 12, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 9 }, { type: 'basic', count: 9 }] 
        }
        // Wave 28
        , { 
        ...
        // Wave 31
        , { 
            enemyHealth_multiplier: 6.39, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 12, healthMultiplier: 3 }, { type: 'frog', count: 28 }, { type: 'shieldknight', count: 5, healthMultiplier: 2 }, { type: 'villager', count: 14 }, { type: 'basic', count: 13 }, { type: 'mage', count: 9 }, { type: 'archer', count: 12, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 32
        , { 
            enemyHealth_multiplier: 6.52, 
            speedMultiplier: 1, 
            spawnInterval: 4, 
        ...
        // Wave 34
        , { 
            enemyHealth_multiplier: 6.77, 
            speedMultiplier: 1.4, 
            spawnInterval: 0.8, 
            pattern: [{ type: 'archer', count: 19 }, { type: 'basic', count: 22 }, { type: 'villager', count: 20 }, { type: 'frog', count: 5 }] 
        }
        // Wave 35
        , { 
            enemyHealth_multiplier: 6.9, 
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'mage', count: 7 }, { type: 'shieldknight', count: 5 }, { type: 'basic', count: 17 }, { type: 'mage', count: 6, healthMultiplier: 4 }, { type: 'beefyenemy', count: 15, healthMultiplier: 2 }, { type: 'shieldknight', count: 5 }, { type: 'frog', count: 35 }, { type: 'archer', count: 16, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'mage', count: 5, healthMultiplier: 6 }] 
        }
        // Wave 36
        , { 
            enemyHealth_multiplier: 7.03, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.72, 
            pattern: [{ type: 'archer', count: 12, healthMultiplier: 2.5, speedMultiplier: 1.1 }, { type: 'frog', count: 27, healthMultiplier: 1.8 }, { type: 'mage', count: 6, healthMultiplier: 2 }, { type: 'archer', count: 7, healthMultiplier: 3, speedMultiplier: 1.5 }] 
        }
        // Wave 38
        , { 
            enemyHealth_multiplier: 7.28, 
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'knight', count: 6, healthMultiplier: 2.5 }, { type: 'mage', count: 10 }, { type: 'frog', count: 29, speedMultiplier: 1.3 }, { type: 'archer', count: 14, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 11 }, { type: 'basic', count: 11 }] 
        }
        // Wave 39
        , { 
            enemyHealth_multiplier: 7.41, 
            speedMultiplier: 1, 
            spawnInterval: 3.8, 
        ...
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 13, healthMultiplier: 3 }, { type: 'frog', count: 37 }, { type: 'mage', count: 7 }, { type: 'basic', count: 15 }, { type: 'villager', count: 14 }, { type: 'shieldknight', count: 10 }, { type: 'archer', count: 13, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 43
        , { 
