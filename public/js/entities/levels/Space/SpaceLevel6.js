...
export class SpaceLevel6 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'ramcart', count: 5, healthMultiplier: 2.5 }, { type: 'shieldknight', count: 8, healthMultiplier: 2 }, { type: 'frog', count: 13, speedMultiplier: 1.3 }, { type: 'archer', count: 12, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 9 }, { type: 'basic', count: 9 }] 
        }
        // Wave 14
        , { 
            enemyHealth_multiplier: 5.47, 
            speedMultiplier: 1, 
            spawnInterval: 0.66, 
        ...
        // Wave 15
        , { 
            enemyHealth_multiplier: 5.64, 
            speedMultiplier: 1, 
            spawnInterval: 11.9, 
            pattern: [{ type: 'ramcart', count: 6 }, { type: 'frog', count: 4 }] 
        }
        // Wave 16
        , { 
            enemyHealth_multiplier: 5.81, 
            speedMultiplier: 1, 
            spawnInterval: 4.7, 
        ...
        // Wave 21
        , { 
            enemyHealth_multiplier: 6.65, 
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'shieldknight', count: 7, healthMultiplier: 3 }, { type: 'mage', count: 5 }, { type: 'basic', count: 16 }, { type: 'shieldknight', count: 6, healthMultiplier: 4 }, { type: 'beefyenemy', count: 14, healthMultiplier: 2 }, { type: 'mage', count: 5 }, { type: 'frog', count: 24 }, { type: 'archer', count: 15, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'shieldknight', count: 5, healthMultiplier: 6 }] 
        }
        // Wave 22
        , { 
            enemyHealth_multiplier: 6.82, 
            speedMultiplier: 1, 
            spawnInterval: 0.78, 
        ...
        // Wave 24
        , { 
            enemyHealth_multiplier: 7.15, 
            speedMultiplier: 1.3, 
            spawnInterval: 0.8, 
            pattern: [{ type: 'archer', count: 18 }, { type: 'basic', count: 21 }, { type: 'villager', count: 19 }, { type: 'frog', count: 4 }] 
        }
        // Wave 25
        , { 
            enemyHealth_multiplier: 7.32, 
            speedMultiplier: 1, 
            spawnInterval: 4, 
        ...
        // Wave 26
        , { 
            enemyHealth_multiplier: 7.49, 
            speedMultiplier: 1, 
            spawnInterval: 4, 
            pattern: [{ type: 'waterfrog', count: 1 }, { type: 'earthfrog', count: 1 }, { type: 'walkingfrog', count: 1 }] 
        }
        // Wave 27
        , { 
            enemyHealth_multiplier: 7.66, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 11, healthMultiplier: 3 }, { type: 'frog', count: 24 }, { type: 'ramcart', count: 5, healthMultiplier: 2 }, { type: 'villager', count: 13 }, { type: 'basic', count: 12 }, { type: 'shieldknight', count: 8 }, { type: 'archer', count: 11, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 28
        , { 
        ...
        , { 
            ...
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'knight', count: 6, healthMultiplier: 2.5 }, { type: 'shieldknight', count: 9, healthMultiplier: 2 }, { type: 'frog', count: 22, speedMultiplier: 1.3 }, { type: 'archer', count: 13, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 10 }, { type: 'basic', count: 10 }] 
        }
        // Wave 30
        , { 
        ...
        // Wave 31
        , { 
            enemyHealth_multiplier: 8.33, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 12, healthMultiplier: 3 }, { type: 'frog', count: 28 }, { type: 'mage', count: 6, healthMultiplier: 2 }, { type: 'villager', count: 14 }, { type: 'basic', count: 13 }, { type: 'shieldknight', count: 9 }, { type: 'archer', count: 12, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 32
        , { 
        ...
        // Wave 33
        , { 
            enemyHealth_multiplier: 8.66, 
            speedMultiplier: 1.4, 
            spawnInterval: 0.8, 
            pattern: [{ type: 'archer', count: 19 }, { type: 'basic', count: 22 }, { type: 'villager', count: 20 }, { type: 'walkingfrog', count: 5 }] 
        }
        // Wave 34
        , { 
            enemyHealth_multiplier: 8.83, 
            speedMultiplier: 1.7, 
            spawnInterval: 0.6, 
        ...
        // Wave 38
        , { 
            enemyHealth_multiplier: 9.5, 
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'knight', count: 7, healthMultiplier: 2.5 }, { type: 'shieldknight', count: 10, healthMultiplier: 2 }, { type: 'frog', count: 29, speedMultiplier: 1.3 }, { type: 'archer', count: 14, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 11 }, { type: 'basic', count: 11 }] 
        }
        // Wave 39
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 4, 
            pattern: [{ type: 'waterfrog', count: 1 }, { type: 'walkingfrog', count: 1 }, { type: 'earthfrog', count: 1 }] 
        }
        // Wave 40
        , { 
