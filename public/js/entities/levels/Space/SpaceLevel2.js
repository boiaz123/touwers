...
export class SpaceLevel2 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.86, 
            pattern: [{ type: 'ramcart', count: 1, healthMultiplier: 1, speedMultiplier: 0.8 }, { type: 'frog', count: 8, healthMultiplier: 2, speedMultiplier: 1.2 }] 
        }
        // Wave 3
        , { 
            ...
            speedMultiplier: 0.7, 
            spawnInterval: 0.68, 
            pattern: [{ type: 'beefyenemy', count: 1 }] 
        }
        // Wave 4
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.96, 
            pattern: [{ type: 'ramcart', count: 1, healthMultiplier: 1.5, speedMultiplier: 1 }, { type: 'basic', count: 8, healthMultiplier: 1.8, speedMultiplier: 0.6 }, { type: 'villager', count: 10, healthMultiplier: 1.8 }, { type: 'archer', count: 3, speedMultiplier: 1.5 }] 
        }
        // Wave 5
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.88, 
            pattern: [{ type: 'mage', count: 1, healthMultiplier: 4 }, { type: 'frog', count: 11 }] 
        }
        // Wave 7
        , { 
            ...
            speedMultiplier: 1.2, 
            spawnInterval: 0.78, 
            pattern: [{ type: 'walkingfrog', count: 1, healthMultiplier: 1.2 }, { type: 'basic', count: 8 }, { type: 'archer', count: 10, speedMultiplier: 1.2 }] 
        }
        // Wave 8
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 1.95, 
            pattern: [{ type: 'beefyenemy', count: 4 }, { type: 'heavyfrog', count: 1, healthMultiplier: 1 }] 
        }
        // Wave 9
        , { 
            ...
            speedMultiplier: 1.2, 
            spawnInterval: 0.58, 
            pattern: [{ type: 'knight', count: 1 }, { type: 'villager', count: 9 }, { type: 'frog', count: 8, healthMultiplier: 2, speedMultiplier: 1.3 }] 
        }
        // Wave 10
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 0.7, 
            pattern: [{ type: 'shieldknight', count: 9 }, { type: 'earthfrog', count: 2, healthMultiplier: 3 }] 
        }
        // Wave 11
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.66, 
            pattern: [{ type: 'beefyenemy', count: 9 }, { type: 'waterfrog', count: 3 }] 
        }
        // Wave 15
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.76, 
            pattern: [{ type: 'archer', count: 9, healthMultiplier: 2.5, speedMultiplier: 1.1 }, { type: 'frog', count: 13, healthMultiplier: 1.8 }, { type: 'shieldknight', count: 4, healthMultiplier: 4 }, { type: 'archer', count: 10, healthMultiplier: 3, speedMultiplier: 1.5 }] 
        }
        // Wave 16
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 1, 
            pattern: [{ type: 'mage', count: 6, healthMultiplier: 5, speedMultiplier: 0.6 }, { type: 'frog', count: 11, speedMultiplier: 1.2 }] 
        }
        // Wave 17
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 11.9, 
            pattern: [{ type: 'knight', count: 2, healthMultiplier: 3 }, { type: 'heavyfrog', count: 1 }, { type: 'knight', count: 3, healthMultiplier: 3 }] 
        }
        // Wave 19
        , { 
            ...
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'shieldknight', count: 6, healthMultiplier: 3 }, { type: 'mage', count: 4, healthMultiplier: 6 }, { type: 'basic', count: 15 }, { type: 'shieldknight', count: 5, healthMultiplier: 4 }, { type: 'beefyenemy', count: 13, healthMultiplier: 2 }, { type: 'mage', count: 4 }, { type: 'frog', count: 22 }, { type: 'archer', count: 14, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'shieldknight', count: 4, healthMultiplier: 6 }] 
        }
        // Wave 20
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1.2, 
            spawnInterval: 1, 
            pattern: [{ type: 'heavyfrog', count: 2 }, { type: 'frog', count: 14 }] 
        }
        // Wave 25
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 4, 
            pattern: [{ type: 'mage', count: 1 }, { type: 'waterfrog', count: 1 }, { type: 'heavyfrog', count: 1 }] 
        }
        // Wave 26
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 10, healthMultiplier: 3 }, { type: 'frog', count: 22 }, { type: 'mage', count: 4, healthMultiplier: 6 }, { type: 'villager', count: 12 }, { type: 'basic', count: 11 }, { type: 'shieldknight', count: 7 }, { type: 'archer', count: 10, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 27
        , { 
        ...
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 11, healthMultiplier: 3 }, { type: 'frog', count: 27 }, { type: 'mage', count: 5, healthMultiplier: 8 }, { type: 'villager', count: 13 }, { type: 'basic', count: 12 }, { type: 'shieldknight', count: 8 }, { type: 'archer', count: 11, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 32
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 4, 
            pattern: [{ type: 'mage', count: 1, speedMultiplier: 0.6 }, { type: 'airfrog', count: 1 }] 
        }
        // Wave 33
        , { 
            ...
            speedMultiplier: 1.4, 
            spawnInterval: 0.8, 
            pattern: [{ type: 'knight', count: 3 }, { type: 'basic', count: 11 }, { type: 'villager', count: 19 }, { type: 'archer', count: 13 } ] 
        }
        // Wave 34
        , { 
            enemyHealth_multiplier: 2, 
            speedMultiplier: 1.7, 
            spawnInterval: 0.3, 
            pattern: [{ type: 'archer', count: 45 }, { type: 'frog', count: 15 }] 
        }
        // Wave 35
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.72, 
            pattern: [{ type: 'archer', count: 11, healthMultiplier: 2.5, speedMultiplier: 1.1 }, { type: 'frog', count: 25, healthMultiplier: 1.8 }, { type: 'shieldknight', count: 6, healthMultiplier: 3 }, { type: 'archer', count: 7, healthMultiplier: 3, speedMultiplier: 1.5 }] 
        }
        // Wave 36
        , { 
            ...
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'shieldknight', count: 7, healthMultiplier: 3 }, { type: 'mage', count: 5, healthMultiplier: 10 }, { type: 'basic', count: 16 }, { type: 'shieldknight', count: 6, healthMultiplier: 4 }, { type: 'beefyenemy', count: 14, healthMultiplier: 2 }, { type: 'mage', count: 5 }, { type: 'frog', count: 33 }, { type: 'archer', count: 15, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'shieldknight', count: 5, healthMultiplier: 6 }] 
        }
        // Wave 37
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'shieldknight', count: 8, healthMultiplier: 3 }, { type: 'mage', count: 6 }, { type: 'villager', count: 17 }, { type: 'heavyfrog', count: 1, healthMultiplier: 4 }, { type: 'beefyenemy', count: 15, healthMultiplier: 2 }, { type: 'mage', count: 6 }, { type: 'frog', count: 38 }, { type: 'archer', count: 16, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'shieldknight', count: 6, healthMultiplier: 6 }] 
        }
        // Wave 42
        , { 
