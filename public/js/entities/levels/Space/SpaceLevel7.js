...
export class SpaceLevel7 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        // Wave 11
        , { 
            enemyHealth_multiplier: 5.55, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 10, healthMultiplier: 3 }, { type: 'frog', count: 15 }, { type: 'shieldknight', count: 4, healthMultiplier: 2 }, { type: 'basic', count: 12 }, { type: 'villager', count: 11 }, { type: 'mage', count: 7 }, { type: 'archer', count: 10, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 12
        , { 
            ...
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'knight', count: 5, healthMultiplier: 2.5 }, { type: 'mage', count: 8 }, { type: 'frog', count: 13, speedMultiplier: 1.3 }, { type: 'archer', count: 12, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 9 }, { type: 'villager', count: 9 }] 
        }
        // Wave 13
        , { 
        ...
        // Wave 15
        , { 
            enemyHealth_multiplier: 6.3, 
            speedMultiplier: 0.8, 
            spawnInterval: 0.7, 
            pattern: [{ type: 'mage', count: 10 }, { type: 'frog', count: 3 }] 
        }
        // Wave 16
        , { 
            enemyHealth_multiplier: 6.49, 
            speedMultiplier: 1, 
            spawnInterval: 0.76, 
            pattern: [{ type: 'archer', count: 10, healthMultiplier: 2.5, speedMultiplier: 1.1 }, { type: 'frog', count: 14, healthMultiplier: 1.8 }, { type: 'mage', count: 5, healthMultiplier: 2 }, { type: 'archer', count: 6, healthMultiplier: 3, speedMultiplier: 1.5 }] 
        }
        // Wave 17
        , { 
            enemyHealth_multiplier: 6.68, 
            speedMultiplier: 1, 
            spawnInterval: 1, 
            pattern: [{ type: 'shieldknight', count: 7, speedMultiplier: 0.6 }, { type: 'frog', count: 12, speedMultiplier: 1.2 }] 
        }
        // Wave 18
        , { 
            enemyHealth_multiplier: 6.86, 
            speedMultiplier: 1, 
            spawnInterval: 11.9, 
        ...
        // Wave 19
        , { 
            enemyHealth_multiplier: 7.05, 
            speedMultiplier: 1, 
            spawnInterval: 1, 
            pattern: [{ type: 'knight', count: 4, healthMultiplier: 3 }, { type: 'mage', count: 5 }, { type: 'shieldknight', count: 4, healthMultiplier: 2 }, { type: 'mage', count: 4, healthMultiplier: 4 }, { type: 'frog', count: 4 }] 
        }
        // Wave 20
        , { 
        ...
        // Wave 22
        , { 
            enemyHealth_multiplier: 7.61, 
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'mage', count: 7, healthMultiplier: 3 }, { type: 'shieldknight', count: 5 }, { type: 'villager', count: 16 }, { type: 'mage', count: 6, healthMultiplier: 4 }, { type: 'beefyenemy', count: 14, healthMultiplier: 2 }, { type: 'shieldknight', count: 5 }, { type: 'frog', count: 24 }, { type: 'archer', count: 15, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'mage', count: 5, healthMultiplier: 6 }] 
        }
        // Wave 23
        , { 
        ...
        // Wave 27
        , { 
            enemyHealth_multiplier: 8.55, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 11, healthMultiplier: 3 }, { type: 'frog', count: 24 }, { type: 'shieldknight', count: 5, healthMultiplier: 2 }, { type: 'basic', count: 13 }, { type: 'villager', count: 12 }, { type: 'mage', count: 8 }, { type: 'archer', count: 11, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 28
        , { 
            enemyHealth_multiplier: 8.74, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
        ...
        // Wave 32
        , { 
            enemyHealth_multiplier: 9.49, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 13, healthMultiplier: 3 }, { type: 'frog', count: 30 }, { type: 'shieldknight', count: 7, healthMultiplier: 2 }, { type: 'basic', count: 15 }, { type: 'villager', count: 14 }, { type: 'mage', count: 10 }, { type: 'archer', count: 13, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 33
        , { 
            enemyHealth_multiplier: 9.67, 
            speedMultiplier: 1.4, 
            spawnInterval: 0.8, 
        ...
        // Wave 35
        , { 
            enemyHealth_multiplier: 10.05, 
            speedMultiplier: 1, 
            spawnInterval: 0.72, 
            pattern: [{ type: 'archer', count: 13, healthMultiplier: 2.5, speedMultiplier: 1.1 }, { type: 'frog', count: 29, healthMultiplier: 1.8 }, { type: 'mage', count: 8 }, { type: 'archer', count: 9, healthMultiplier: 3, speedMultiplier: 1.5 }] 
        }
        // Wave 36
        , { 
            enemyHealth_multiplier: 10.24, 
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'mage', count: 9 }, { type: 'shieldknight', count: 7 }, { type: 'villager', count: 18 }, { type: 'mage', count: 8 }, { type: 'beefyenemy', count: 16, healthMultiplier: 2 }, { type: 'shieldknight', count: 7 }, { type: 'frog', count: 37 }, { type: 'archer', count: 17, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'mage', count: 7 }] 
        }
        // Wave 37
        , { 
            enemyHealth_multiplier: 10.43, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
        ...
        // Wave 38
        , { 
            enemyHealth_multiplier: 10.61, 
            speedMultiplier: 0.9, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'knight', count: 8, healthMultiplier: 2.5 }, { type: 'mage', count: 11 }, { type: 'frog', count: 31, speedMultiplier: 1.3 }, { type: 'archer', count: 15, speedMultiplier: 1.4 }, { type: 'beefyenemy', count: 12 }, { type: 'villager', count: 12 }] 
        }
        // Wave 39
        , { 
            enemyHealth_multiplier: 10.8, 
            speedMultiplier: 1, 
            spawnInterval: 3.8, 
        ...
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 14, healthMultiplier: 3 }, { type: 'frog', count: 39 }, { type: 'mage', count: 8 }, { type: 'basic', count: 16 }, { type: 'villager', count: 15 }, { type: 'shieldknight', count: 11 }, { type: 'archer', count: 14, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 43
        , { 
