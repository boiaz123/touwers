...
export class SpaceLevel1 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.88, 
            pattern: [{ type: 'walkingfrog', count: 1, healthMultiplier: 2 }, { type: 'frog', count: 11 }] 
        }
        // Wave 7
        , { 
            enemyHealth_multiplier: 1.67, 
            speedMultiplier: 1.2, 
            spawnInterval: 0.58, 
        ...
        // Wave 8
        , { 
            enemyHealth_multiplier: 1.78, 
            speedMultiplier: 1.2, 
            spawnInterval: 0.78, 
            pattern: [{ type: 'ramcart', count: 2 }] 
        }
        // Wave 9
        , { 
            enemyHealth_multiplier: 1.89, 
            speedMultiplier: 1, 
            spawnInterval: 1.95, 
            pattern: [{ type: 'beefyenemy', count: 4 }, { type: 'walkingfrog', count: 2, healthMultiplier: 1 }] 
        }
        // Wave 10
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 4, 
            pattern: [{ type: 'firefrog', count: 1 }, { type: 'airfrog', count: 1 }] 
       }
        // Wave 11
        , { 
            enemyHealth_multiplier: 2.07, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 8, healthMultiplier: 3 }, { type: 'frog', count: 13 }, { type: 'ramcart', count: 2, healthMultiplier: 2 }, { type: 'basic', count: 10 }, { type: 'villager', count: 9 }, { type: 'shieldknight', count: 5 }, { type: 'archer', count: 8, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 12
        , { 
            enemyHealth_multiplier: 2.14, 
            speedMultiplier: 1, 
            spawnInterval: 0.82, 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.66, 
            pattern: [{ type: 'beefyenemy', count: 8 }, { type: 'ramcart', count: 3 }] 
        }
        // Wave 15
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 11.9, 
            pattern: [{ type: 'walkingfrog', count: 4 }, { type: 'frog', count: 9 }] 
        }
        // Wave 18
        , { 
        ...
        // Wave 19
        , { 
            enemyHealth_multiplier: 2.63, 
            speedMultiplier: 1, 
            spawnInterval: 1, 
            pattern: [{ type: 'mage', count: 5, speedMultiplier: 0.6, healthMultiplier: 6 }, { type: 'frog', count: 10, speedMultiplier: 1.2 }] 
        }
        // Wave 20
        , { 
        ...
        // Wave 21
        , { 
            enemyHealth_multiplier: 2.77, 
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'shieldknight', count: 5, healthMultiplier: 3 }, { type: 'mage', count: 3, healthMultiplier: 10 }, { type: 'villager', count: 14 }, { type: 'shieldknight', count: 4, healthMultiplier: 4 }, { type: 'beefyenemy', count: 12, healthMultiplier: 2 }, { type: 'mage', count: 3 }, { type: 'frog', count: 21 }, { type: 'archer', count: 13, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'shieldknight', count: 3, healthMultiplier: 6 }] 
        }
        // Wave 22
        , { 
            enemyHealth_multiplier: 2.84, 
            speedMultiplier: 1, 
            spawnInterval: 4.7, 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 4, 
            pattern: [{ type: 'mage', count: 1, healthMultiplier: 5 }, { type: 'waterfrog', count: 1 }] 
        }
        // Wave 26
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 9, healthMultiplier: 3 }, { type: 'frog', count: 21 }, { type: 'mage', count: 3, healthMultiplier: 5 }, { type: 'basic', count: 11 }, { type: 'villager', count: 10 }, { type: 'shieldknight', count: 6 }, { type: 'archer', count: 9, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 27
        , { 
        ...
        // Wave 31
        , { 
            enemyHealth_multiplier: 3.47, 
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 10, healthMultiplier: 3 }, { type: 'frog', count: 25 }, { type: 'ramcart', count: 4, healthMultiplier: 2 }, { type: 'basic', count: 12 }, { type: 'villager', count: 11 }, { type: 'shieldknight', count: 7 }, { type: 'archer', count: 10, healthMultiplier: 3, speedMultiplier: 2 }] 
        }
        // Wave 32
        , { 
            enemyHealth_multiplier: 3.54, 
            speedMultiplier: 1, 
            spawnInterval: 4, 
        ...
        , { 
            ...
            speedMultiplier: 1.7, 
            spawnInterval: 0.6, 
            pattern: [{ type: 'archer', count: 15 }, { type: 'walkingfrog', count: 5 }] 
        }
        // Wave 35
        , { 
            enemyHealth_multiplier: 3.75, 
            speedMultiplier: 1, 
            spawnInterval: 0.72, 
        ...
        , { 
            ...
            speedMultiplier: 1.1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'shieldknight', count: 6, healthMultiplier: 3 }, { type: 'mage', count: 4, healthMultiplier: 10 }, { type: 'villager', count: 15 }, { type: 'shieldknight', count: 5, healthMultiplier: 4 }, { type: 'beefyenemy', count: 13, healthMultiplier: 2 }, { type: 'mage', count: 4 }, { type: 'frog', count: 31 }, { type: 'archer', count: 14, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'shieldknight', count: 4, healthMultiplier: 6 }] 
        }
        // Wave 37
        , { 
