...
export class DesertLevel3 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.8, 
            pattern: [{ type: 'mage', count: 2, healthMultiplier: 0.8 }, { type: 'frog', count: 12 }] 
        }
        // Wave 6
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.5, 
            pattern: [{ type: 'mage', count: 2, healthMultiplier: 3, speedMultiplier: 0.8 }, { type: 'frog', count: 20, speedMultiplier: 1.3 }] 
        }
        // Wave 13
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.9, 
            pattern: [{ type: 'mage', count: 1, healthMultiplier: 3, speedMultiplier: 1.2 }, { type: 'villager', count: 10 }, { type: 'basic', count: 6 }, { type: 'archer', count: 6 }, { type: 'beefyenemy', count: 9, healthMultiplier: 4 }] 
        }
        // Wave 15
        , { 
            enemyHealth_multiplier: 4, 
        ...
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'knight', count: 3 }, { type: 'frog', count: 12 }, { type: 'mage', count: 1, healthMultiplier: 3 }] 
        }
        // Wave 17
        , { 
            enemyHealth_multiplier: 4, 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.5, 
            pattern: [{ type: 'frog', count: 12, healthMultiplier: 2 }, { type: 'mage', count: 1, healthMultiplier: 10 }, { type: 'archer', count: 12, healthMultiplier: 3, speedMultiplier: 1.4 }, { type: 'shieldknight', count: 3, healthMultiplier: 2 }, { type: 'knight', count: 1, healthMultiplier: 2 }, { type: 'beefyenemy', count: 4, healthMultiplier: 5 }, { type: 'basic', count: 4, healthMultiplier: 5 }, { type: 'villager', count: 5, healthMultiplier: 5 }] 
        }
        // Wave 22
        , { 
