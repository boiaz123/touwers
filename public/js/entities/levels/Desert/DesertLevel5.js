...
export class DesertLevel5 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 1.2, 
            pattern: [{ type: 'shieldknight', count: 3 }, { type: 'beefyenemy', count: 6, healthMultiplier: 2 }, { type: 'shieldknight', count: 1, healthMultiplier: 3 }, { type: 'beefyenemy', count: 9, healthMultiplier: 7 }, { type: 'shieldknight', count: 2, healthMultiplier: 3 }] 
        }
        // Wave 8
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 2, 
            pattern: [{ type: 'shieldknight', count: 3, healthMultiplier: 1 }, { type: 'beefyenemy', count: 5 }, { type: 'knight', count: 1, healthMultiplier: 1 }, { type: 'shieldknight', count: 3 }, { type: 'beefyenemy', count: 6, healthMultiplier: 6 }, { type: 'knight', count: 1, healthMultiplier: 2, speedMultiplier: 0.8 }, { type: 'ramcart', count: 1 }]
        }
        // Wave 11
        , { 
            enemyHealth_multiplier: 3, 
        ...
        , { 
            ...
            speedMultiplier: 0.8, 
            spawnInterval: 1, 
            pattern: [{ type: 'beefyenemy', count: 7, healthMultiplier: 15 }, { type: 'frog', count: 12 }, { type: 'mage', count: 2, healthMultiplier: 10 }, { type: 'basic', count: 11 }, { type: 'villager', count: 9 }, { type: 'shieldknight', count: 4 }, { type: 'archer', count: 9, healthMultiplier: 4, speedMultiplier: 2 }] 
        }
        // Wave 16
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.5, 
            pattern: [{ type: 'knight', count: 1, healthMultiplier: 4 }, { type: 'shieldknight', count: 2 }] 
        }
        // Wave 17
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 5, 
            pattern: [{ type: 'mage', count: 5, speedMultiplier: 0.6 }, { type: 'frog', count: 8, healthMultiplier: 5, speedMultiplier: 1.6 }, { type: 'walkingfrog', count: 1 }]
        }
        // Wave 18
        , { 
            enemyHealth_multiplier: 4, 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 1, 
            pattern: [{ type: 'shieldknight', count: 4, healthMultiplier: 3 }, { type: 'mage', count: 1, healthMultiplier: 15 }, { type: 'villager', count: 12 }, { type: 'shieldknight', count: 3, healthMultiplier: 4 }, { type: 'beefyenemy', count: 8 }, { type: 'mage', count: 1 }, { type: 'frog', count: 12 }, { type: 'archer', count: 9, healthMultiplier: 5, speedMultiplier: 1.5 }, { type: 'shieldknight', count: 2, healthMultiplier: 5, speedMultiplier: 0.8 }] 
        }
        // Wave 22
        , { 
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 0.5, 
            pattern: [{ type: 'mage', count: 1, healthMultiplier: 12 }, { type: 'frog', count: 18, healthMultiplier: 3, speedMultiplier: 1.8 }] 
        }
        // Wave 24
        , { 
            enemyHealth_multiplier: 2.5, 
            speedMultiplier: 1, 
            spawnInterval: 0.6, 
            pattern: [{ type: 'shieldknight', count: 3, speedMultiplier: 1.2 }, { type: 'beefyenemy', count: 9, healthMultiplier: 4 }, { type: 'frog', count: 16 }, { type: 'villager', count: 11 }, { type: 'archer', count: 13 }, { type: 'knight', count: 1, healthMultiplier: 7, speedMultiplier: 0.5 }] 
        }
        // Wave 25
        , { 
            enemyHealth_multiplier: 8, 
            speedMultiplier: 1, 
            spawnInterval: 0.8, 
            pattern: [{ type: 'knight', count: 1, healthMultiplier: 15 }, { type: 'mage', count: 3 }] 
        }
        // Wave 26
        , { 
            enemyHealth_multiplier: 10, 
