...
export class DesertLevel6 extends LevelBase {
    ...
    getWaveConfig(wave) {
        ...
        , { 
            ...
            speedMultiplier: 1, 
            spawnInterval: 2, 
            pattern: [{ type: 'shieldknight', count: 2, healthMultiplier: 2 }, { type: 'beefyenemy', count: 5, healthMultiplier: 2 }, { type: 'knight', count: 1, healthMultiplier: 1.3 }, { type: 'shieldknight', count: 3 }, { type: 'beefyenemy', count: 7, healthMultiplier: 5 }, { type: 'knight', count: 1, healthMultiplier: 2, speedMultiplier: 0.8 }] 
        }
        // Wave 12
        , { 
            enemyHealth_multiplier: 3, 
