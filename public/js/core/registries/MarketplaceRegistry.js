...
export class MarketplaceRegistry {
    static #registry = {
        ...
        'music-frogkings-8': {
            ...
            category: 'music',
            type: 'music',
            musicId: 'campaign-4-battle-8',
            effect: "Unlock Frog King's Domain battle theme to be played within the Arcane Library",
            requirements: ['musical-equipment'],
            campaignRequirement: 'campaign-4'
        },
        'music-bonus-level': {
            name: "Frog King's Realm Theme",
            description: 'The hidden bonus realm where the Frog King\'s legend truly began. A whimsical yet ominous melody.',
            cost: 150,
            drawIcon: _drawMusicNote,
            category: 'music',
            type: 'music',
            musicId: 'bonus-level-theme',
            effect: "Unlock Frog King's Realm theme to be played within the Arcane Library",
            requirements: ['musical-equipment'],
            campaignRequirement: 'campaign-4'
        },
